...
def p_repeat_till_quit(action: callable, do_while: True, continue_keyword: str='continue', quit_keyword: str='quit', continue_string: str='', quit_string: str='Q', indent: int=0):
    if do_while:
        action()
